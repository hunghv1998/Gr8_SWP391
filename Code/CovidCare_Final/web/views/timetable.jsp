...
<html lang="en">
    ...
    <body class="body-wrapper">
        ...
        <div class="container theme-showcase">
            ...
            <div class="col-md-12 col-lg-12" style="align-items: center; justify-content: center; ">
                <h1>Thời gian biểu hằng ngày</h1>
                <button class="d-block py-3 px-5 bg-primary text-white border-0 rounded font-weight-bold mt-3" onclick="location.href = 'timetable?action=add'">Thêm việc cần làm</button>
            </div>
