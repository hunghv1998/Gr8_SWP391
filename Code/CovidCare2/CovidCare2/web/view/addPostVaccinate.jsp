            ...
            <div class="container">
                ...
                <div class="row">       
                    <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                        <!-- Recently Favorited -->
                        <form action="addPostVaccinate" method="post" enctype="multipart/form-data">
                                ...
                                <table class="table table-responsive product-dashboard-table">
                                    ...
                                    <div class="col-lg-12">
                                      <div class="dnx_content_form_item clearfix">
                                        ...
                                        <textarea name="note" id="" class="border p-3 w-100" rows="7" placeholder="Ghi chú vào đây"></textarea>
                                        <h6 class="font-weight-bold pt-4 pb-1">Số lượng mũi tiêm có sẵn :</h6>
                                        <input type="text" name="place" class="border w-100 p-2 bg-white text-capitalize" placeholder="Nhập số lượng mũi vào đây">  
                                    </div>
                                    </tbody>
                                </table>                                                                                                         
